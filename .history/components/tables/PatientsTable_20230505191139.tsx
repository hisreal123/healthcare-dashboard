...
export default function PatientTable({ patientStyle }: PatientTableProps) {
    ...
    const PatientList = patients.map((patient: any, index: number) => {
        return (
            <>
                <tbody key={index} className="flex-1 w-full flex relative justify-between">
                    <tr>
    ...
    const PTable = () => {
        return (
            <>
                <table className="relative w-full  inline-block">
                    <thead>
                        <tr className='flex-1 w-full flex relative justify-between'>
                            <th>Name</th>
                            <th>Age</th>
                            <th>Email</th>
                            <th>gender</th>
