        ...
        <>
            <section className="flex space-x-4">
                <div id="sidebar" className="  h-screen shadow-xl group">
                    <div className="px-4 wrapper w-[20px] group-hover:w-auto">
                                ...
                                {list.map((list, index) => {
                                    return (
                                        <li key={index} className="flex space-x-2 items-center py-3 last:border-t ">
                                            ...
                                            <a href={`./${list.link}`} className="hidden group-hover:block transition-all delay-200 duration-500">{list.name}</a>
                                        </li>
                                    )
                                })}
                            </ul>
