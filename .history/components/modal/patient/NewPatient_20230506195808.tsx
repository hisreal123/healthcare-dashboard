            ...
            <Modal isOpen={modal} toggle={toggle} {...args} className='rounded-none' >
                ...
                <ModalBody>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button
                            type='submit'
                            className={`${!allCheck ? 'hover:bg-gray-200' : 'bg-[#5282FB] hover:bg-[#0e46d3]'} disabled:cursor-not-allowed  text-white font-light text-lg  mt-3 w-full relative py-2 rounded-sm `}
