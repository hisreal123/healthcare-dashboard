            ...
            <section className='flex items-center justify-between relative w-full'>
                ...
                <div className="right flex  items-center space-x-3">
                    ...
                    <span className='relative group'>
                        <BsFillBellFill className="text-xl text-gray-300 rotate-[25deg] group-hover:text-gray-400" />
                    ...
                    <div className=" h-6 w-6 overflow-hidden rounded-full bg-black hover:h-6 hover:w-6">
