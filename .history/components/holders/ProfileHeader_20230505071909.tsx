            ...
            <section className='flex items-center justify-between relative w-full'>
                ...
                <div className="right flex  items-center space-x-3">
                    ...
                    <span className='relative group'>
                        ...
                        <span className="absolute -top-1 -right-1 text-xs text-white border-2 border-white  bg-red-400  group-hover:bg-rounded-full h-4 w-4  flex items-center  justify-center">
                            {count}
                        </span>
                    </span>
