            ...
            <section className='flex items-center justify-between relative w-full'>
                ...
                <div className="right flex  items-center space-x-3">
                    ...
                    <span className='relative group'>
                        ...
                        <span className=" cursor-pointer absolute lg:-top-1 lg:-right-1 text-white border-2 border-white  bg-red-400  group-hover:bg-red-600 rounded-full lg:h-5 lg:w-5  flex items-center  justify-center">
                            {count}
                        </span>
                    </span>
