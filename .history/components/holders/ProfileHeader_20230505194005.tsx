            ...
            <section className='flex items-center justify-between relative w-full'>
                ...
                <div className="right flex  items-center space-x-3">
                    ...
                    <span className='relative group'>
                        ...
                        <span className=" cursor-pointer absolute -top-1 -right-1 text-white border-2 border-white  bg-red-400  group-hover:bg-red-600 rounded-full lg:h-4 lg:w-4  flex items-center  justify-center">
                            {count}
                        </span>
                    </span>
